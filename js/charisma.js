$(document).ready(function(){
	...
	var current_theme = $.session.get('current_theme')==null ? 'cerulean' :$.session.get('current_theme');
	...
	$('#themes a').click(function(e){
		...
		e.preventDefault();
		current_theme=$(this).attr('data-value');
		$.session.set('current_theme',current_theme);
		switch_theme(current_theme);
		$('#themes i').removeClass('icon-ok');
		$(this).find('i').addClass('icon-ok');
	});
	...
	function switch_theme(theme_name) {
		$('#bs-css').attr('href',baseurl+'/css/bootstrap-'+theme_name+'.css');
	}
	...
	$('ul.main-menu li a').each(function(){
		//if($($(this))[0].href==String(window.location))
		 if($($(this))[0].href==(site_url+'/'+folder_name+'/'+controller_name))
